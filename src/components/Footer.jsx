...
export default function Footer() {
  return (
    <div >
      <footer className=" lg:ml-50 md:ml-50 sm:ml-50 ml-5 bg-white   sticky bottom-0 left-0 right-0  dark:bg-gray-900">
        <div className=" w-100 lg:w-full md:w-full sm:w-full   p-4 py-6 lg:py-8">
